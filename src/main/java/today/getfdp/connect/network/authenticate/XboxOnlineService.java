...
import today.getfdp.connect.utils.ByteUtilsKt;
...
// copy & paste from https://github.com/THEREALWWEFAN231/TunnelMC/blob/64da51a7288bd2fb37cdeef4a945d3fe90b43156/src/main/java/me/THEREALWWEFAN231/tunnelmc/auth/Xbox.java
public class XboxOnlineService {
    ...
    public XboxOnlineService(String accessToken) {
    ...
    public String getUserToken(ECPublicKey publicKey, ECPrivateKey privateKey) throws Exception {
        ...
        String responce = ByteUtilsKt.readInputStream(connection.getInputStream());
    ...
    public String getXstsToken(String userToken, String deviceToken, String titleToken, ECPublicKey publicKey, ECPrivateKey privateKey) throws Exception {
        ...
        return ByteUtilsKt.readInputStream(connection.getInputStream());
    }
    ...
    public String requestMinecraftChain(String xsts, ECPublicKey publicKey) throws Exception {
        ...
        connection.setRequestProperty("Client-Version", FConnect.INSTANCE.getBedrockCodec().getMinecraftVersion());
    ...
    private void addSignatureHeader(HttpsURLConnection httpsURLConnection, JsonObject postData, ECPrivateKey privateKey) throws Exception {
        ...
        bytesToSign.write(long2bytes(currentTime));
        ...
        bytesToSign.write(new byte[] { 0 });
        bytesToSign.write(gson.toJson(postData).getBytes());
        bytesToSign.write(new byte[] { 0 });
        ...
        byteArrayOutputStream.write(long2bytes(currentTime));
