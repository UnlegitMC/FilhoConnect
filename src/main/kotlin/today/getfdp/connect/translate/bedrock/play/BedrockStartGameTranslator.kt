...
import today.getfdp.connect.play.entity.EntityHuman
...
class BedrockStartGameTranslator : TranslatorBase<StartGamePacket> {
    ...
    override fun translate(provider: BedrockProxyProvider, packet: StartGamePacket) {
        ...
        provider.client.theWorld.spawn(provider.client.thePlayer)
        provider.client.thePlayer.updatePositionAbsulute(packet.playerPosition)
